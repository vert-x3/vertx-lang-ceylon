ceylon import-jar --descriptor=descriptors/com.fasterxml.jackson.core.jackson-core.properties com.fasterxml.jackson.core.jackson-core/2.5.3 ~/.m2/repository/com/fasterxml/jackson/core/jackson-core/2.5.3/jackson-core-2.5.3.jar
ceylon import-jar --descriptor=descriptors/com.fasterxml.jackson.core.jackson-annotations.properties com.fasterxml.jackson.core.jackson-annotations/2.5.0 ~/.m2/repository/com/fasterxml/jackson/core/jackson-annotations/2.5.0/jackson-annotations-2.5.0.jar
ceylon import-jar --descriptor=descriptors/com.fasterxml.jackson.core.jackson-databind.properties com.fasterxml.jackson.core.jackson-databind/2.5.3 ~/.m2/repository/com/fasterxml/jackson/core/jackson-databind/2.5.3/jackson-databind-2.5.3.jar
ceylon import-jar --descriptor=descriptors/io.netty.netty-common.properties io.netty.netty-common/4.0.28.Final ~/.m2/repository/io/netty/netty-common/4.0.28.Final/netty-common-4.0.28.Final.jar
ceylon import-jar --descriptor=descriptors/io.netty.netty-buffer.properties io.netty.netty-buffer/4.0.28.Final ~/.m2/repository/io/netty/netty-buffer/4.0.28.Final/netty-buffer-4.0.28.Final.jar
ceylon import-jar --descriptor=descriptors/io.netty.netty-transport.properties io.netty.netty-transport/4.0.28.Final ~/.m2/repository/io/netty/netty-transport/4.0.28.Final/netty-transport-4.0.28.Final.jar
