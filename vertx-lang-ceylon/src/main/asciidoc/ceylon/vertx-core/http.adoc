...
The proxy can be configured in the `link:../../ceylondoc/vertx-core//http/HttpClientOptions.type.html[HttpClientOptions]` by setting hostname, port and optionally
