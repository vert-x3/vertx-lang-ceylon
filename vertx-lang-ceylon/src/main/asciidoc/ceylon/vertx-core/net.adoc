...
OpenSSL requires to configure `link:../../ceylondoc/vertx-core//net/TCPSSLOptions.type.html#setSslEngine(io.vertx.core.net.SSLEngine)[sslEngine]` to `link:todo[OPENSSL]`
