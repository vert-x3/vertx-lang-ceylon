...
You can set an `link:../../ceylondoc/vertx-core//net/NetServer.type.html#exceptionHandler(io.vertx.core.Handler)[exceptionHandler]` to receive any
exceptions that happens before the connection is passed to the `link:../../ceylondoc/vertx-core//net/NetServer.type.html#connectHandler((@io.vertx.codegen.annotations.Nullable :: io.vertx.core.Handler))[connectHandler]`
...
[source,ceylon]
----
Code not translatable : io.vertx.codetrans.expression.DataObjectLiteralModel has not implemented: Method MethodSignature[name=removeEnabledSecureTransportProtocol,parameters=[java.lang.String],varargs=false]
----
...
* if `link:../../ceylondoc/vertx-core//net/JksOptions.type.html[JksOptions]` were used to set the trust options
 (`link:../../ceylondoc/vertx-core//net/NetServerOptions.type.html#setTrustOptions(io.vertx.core.net.TrustOptions)[options]`) then an exact match with the trust store
 alias is done
