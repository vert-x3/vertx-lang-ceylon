...
[source,ceylon]
----
value vertx = vertx.vertx(VertxOptions {
  workerPoolSize = 40;
});
...
[source,ceylon]
----
vertx.setPeriodic(1000, (Long id) => {
...
[source, ceylon]
----
vertx.getOrCreateContext().runOnContext((Void v) => {
...
[source,ceylon]
----
value timerID = vertx.setTimer(1000, (Long id) => {
...
[source,ceylon]
----
value timerID = vertx.setPeriodic(1000, (Long id) => {
