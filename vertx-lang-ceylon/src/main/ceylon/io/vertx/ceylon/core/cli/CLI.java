...
public class CLI implements ReifiedType {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(CLI.class), io.vertx.core.cli.CLI.class, TO_JAVA, TO_CEYLON);
