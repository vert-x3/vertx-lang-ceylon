...
public class Counter implements ReifiedType {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(Counter.class), io.vertx.core.shareddata.Counter.class, TO_JAVA, TO_CEYLON);
