...
public class CommandLine implements ReifiedType {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(CommandLine.class), io.vertx.core.cli.CommandLine.class, TO_JAVA, TO_CEYLON);
