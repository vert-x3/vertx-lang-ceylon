...
public class DatagramSocket implements ReifiedType,  ReadStream<DatagramPacket>,  Measured {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(DatagramSocket.class), io.vertx.core.datagram.DatagramSocket.class, TO_JAVA, TO_CEYLON);
