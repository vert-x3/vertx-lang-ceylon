...
public class FileSystem implements ReifiedType {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(FileSystem.class), io.vertx.core.file.FileSystem.class, TO_JAVA, TO_CEYLON);
