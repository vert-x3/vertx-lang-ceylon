...
public class EventBus implements ReifiedType,  Measured {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(EventBus.class), io.vertx.core.eventbus.EventBus.class, TO_JAVA, TO_CEYLON);
  ...
  @DocAnnotation$annotation$(description = " Like [send](../eventbus/EventBus.type.html#send) but specifying a <code>replyHandler</code> that will be called if the recipient\n subsequently replies to the message.\n")
  @TypeInfo("io.vertx.ceylon.core.eventbus::EventBus")
  ...
  @DocAnnotation$annotation$(description = " Like [send](../eventbus/EventBus.type.html#send) but specifying <code>options</code> that can be used to configure the delivery.\n")
  @TypeInfo("io.vertx.ceylon.core.eventbus::EventBus")
  public EventBus send(
    final @TypeInfo("ceylon.language::String") @Name("address")@DocAnnotation$annotation$(description = "the address to send it to\n") ceylon.language.String address, 
    final @TypeInfo("ceylon.language::Object?") @Name("message")@DocAnnotation$annotation$(description = "the message, may be <code>null</code>\n") Object message, 
  ...
  @DocAnnotation$annotation$(description = " Like [publish](../eventbus/EventBus.type.html#publish) but specifying <code>options</code> that can be used to configure the delivery.\n")
  @TypeInfo("io.vertx.ceylon.core.eventbus::EventBus")
  public EventBus publish(
    final @TypeInfo("ceylon.language::String") @Name("address")@DocAnnotation$annotation$(description = "the address to publish it to\n") ceylon.language.String address, 
    final @TypeInfo("ceylon.language::Object?") @Name("message")@DocAnnotation$annotation$(description = "the message, may be <code>null</code>\n") Object message, 
  ...
  public EventBus addInterceptor(
    final @TypeInfo("ceylon.language::Anything(io.vertx.ceylon.core.eventbus::SendContext)") @Name("interceptor")@DocAnnotation$annotation$(description = "the interceptor\n") Callable<?> interceptor) {
