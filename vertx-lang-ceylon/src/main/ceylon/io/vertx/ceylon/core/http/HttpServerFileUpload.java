...
public class HttpServerFileUpload implements ReifiedType,  ReadStream<Buffer> {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(HttpServerFileUpload.class), io.vertx.core.http.HttpServerFileUpload.class, TO_JAVA, TO_CEYLON);
