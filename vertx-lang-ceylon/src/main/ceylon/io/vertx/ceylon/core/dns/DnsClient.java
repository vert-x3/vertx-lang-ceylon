...
public class DnsClient implements ReifiedType {
  ...
  public DnsClient lookup(
    ...
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|ceylon.language::String?)") @Name("handler") @DocAnnotation$annotation$(description = "the `handler` to notify with the `io.vertx.core.AsyncResult`. The handler will get notified with the resolved address if a record was found. If non was found it will get notifed with <code>null</code>. If an error accours it will get failed.\n") Callable<?> handler) {
  ...
  public DnsClient resolveA(
    final @TypeInfo("ceylon.language::String") @Name("name") @DocAnnotation$annotation$(description = "the name to resolve\n") ceylon.language.String name, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|ceylon.language::List<ceylon.language::String>)") @Name("handler") @DocAnnotation$annotation$(description = "the `handler` to notify with the `io.vertx.core.AsyncResult`. The handler will get notified with a `java.util.List` that contains all the resolved `java.net.Inet4Address`es. If none was found an empty `java.util.List` will be used. If an error accours it will get failed.\n") Callable<?> handler) {
    java.lang.String arg_0 = io.vertx.lang.ceylon.ToJava.String.safeConvert(name);
  ...
  public DnsClient resolveAAAA(
    final @TypeInfo("ceylon.language::String") @Name("name") @DocAnnotation$annotation$(description = "the name to resolve\n") ceylon.language.String name, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|ceylon.language::List<ceylon.language::String>)") @Name("handler") @DocAnnotation$annotation$(description = "the `handler` to notify with the `io.vertx.core.AsyncResult`. The handler will get notified with a `java.util.List` that contains all the resolved `java.net.Inet6Address`es. If none was found an empty `java.util.List` will be used. If an error accours it will get failed.\n") Callable<?> handler) {
    java.lang.String arg_0 = io.vertx.lang.ceylon.ToJava.String.safeConvert(name);
    io.vertx.core.Handler<io.vertx.core.AsyncResult<java.util.List<java.lang.String>>> arg_1 = handler == null ? null : new io.vertx.lang.ceylon.AsyncResultAdapter<java.util.List<java.lang.String>>(handler) {
      public Object toCeylon(java.util.List<java.lang.String> event) {
        return io.vertx.lang.ceylon.ToCeylon.convertList(ceylon.language.String.$TypeDescriptor$, event, io.vertx.lang.ceylon.ToCeylon.String);
  ...
  public DnsClient resolveMX(
    ...
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|ceylon.language::List<io.vertx.ceylon.core.dns::MxRecord>)") @Name("handler") @DocAnnotation$annotation$(description = "the `handler` to notify with the `io.vertx.core.AsyncResult`. The handler will get notified with a List that contains all resolved [MxRecord](../dns/MxRecord.type.html)s, sorted by their [priority](../dns/MxRecord.type.html#priority). If non was found it will get notified with an empty `java.util.List`. If an error accours it will get failed.\n") Callable<?> handler) {
    java.lang.String arg_0 = io.vertx.lang.ceylon.ToJava.String.safeConvert(name);
