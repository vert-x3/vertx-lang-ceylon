...
@Ceylon(major = 8)
@DocAnnotation$annotation$(description = " A [ReadStream](../streams/ReadStream.type.html) of [HttpServerRequest](../http/HttpServerRequest.type.html), used for\n notifying http request to a [HttpServer](../http/HttpServer.type.html).\n")
public class HttpServerRequestStream implements ReifiedType,  ReadStream<HttpServerRequest> {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(HttpServerRequestStream.class), io.vertx.core.http.HttpServerRequestStream.class, TO_JAVA, TO_CEYLON);
