...
public class ServerWebSocketStream implements ReifiedType,  ReadStream<ServerWebSocket> {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(ServerWebSocketStream.class), io.vertx.core.http.ServerWebSocketStream.class, TO_JAVA, TO_CEYLON);
