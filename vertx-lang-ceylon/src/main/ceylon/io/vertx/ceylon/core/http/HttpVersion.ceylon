...
shared object toJavaHttpVersion extends Converter<HttpVersion, HttpVersion_>() {
...
shared object toCeylonHttpVersion extends Converter<HttpVersion_, HttpVersion>() {
