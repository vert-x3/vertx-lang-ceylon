...
public class TimeoutStream implements ReifiedType,  ReadStream<ceylon.language.Integer> {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(TimeoutStream.class), io.vertx.core.TimeoutStream.class, TO_JAVA, TO_CEYLON);
