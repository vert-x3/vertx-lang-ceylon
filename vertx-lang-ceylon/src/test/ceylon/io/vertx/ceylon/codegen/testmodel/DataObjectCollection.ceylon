...
shared object toCeylonDataObjectCollection extends Converter<DataObjectCollection_, DataObjectCollection>() {
...
shared object toJavaDataObjectCollection extends Converter<DataObjectCollection, DataObjectCollection_>() {
