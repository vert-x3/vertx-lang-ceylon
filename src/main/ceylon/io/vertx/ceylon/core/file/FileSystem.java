...
public class FileSystem {
  ...
  public FileSystem copy(
    final @TypeInfo("ceylon.language::String") ceylon.language.String from, 
    final @TypeInfo("ceylon.language::String") ceylon.language.String to, 
  ...
  public FileSystem copyRecursive(
    final @TypeInfo("ceylon.language::String") ceylon.language.String from, 
    final @TypeInfo("ceylon.language::String") ceylon.language.String to, 
    final @TypeInfo("ceylon.language::Boolean") boolean recursive, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable?)") Callable<?> handler) {
    java.lang.String arg_0 = from.toString();
    java.lang.String arg_1 = to.toString();
  ...
  public FileSystem truncate(
    ...
    final @TypeInfo("ceylon.language::Integer") long len, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable?)") Callable<?> handler) {
  ...
  public FileSystem chmod(
    final @TypeInfo("ceylon.language::String") ceylon.language.String path, 
    final @TypeInfo("ceylon.language::String") ceylon.language.String perms, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable?)") Callable<?> handler) {
    java.lang.String arg_0 = path.toString();
  ...
  public FileSystem chmodRecursive(
    final @TypeInfo("ceylon.language::String") ceylon.language.String path, 
    final @TypeInfo("ceylon.language::String") ceylon.language.String perms, 
    final @TypeInfo("ceylon.language::String") ceylon.language.String dirPerms, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable?)") Callable<?> handler) {
    java.lang.String arg_0 = path.toString();
    java.lang.String arg_1 = perms.toString();
  ...
  public FileSystem chown(
    final @TypeInfo("ceylon.language::String") ceylon.language.String path, 
    final @TypeInfo("ceylon.language::String") ceylon.language.String user, 
    final @TypeInfo("ceylon.language::String") ceylon.language.String group, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable?)") Callable<?> handler) {
    java.lang.String arg_0 = path.toString();
  ...
  public FileSystem props(
    final @TypeInfo("ceylon.language::String") ceylon.language.String path, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|io.vertx.ceylon.core.file::FileProps)") Callable<?> handler) {
    java.lang.String arg_0 = path.toString();
  ...
  public FileSystem link(
    final @TypeInfo("ceylon.language::String") ceylon.language.String link, 
    final @TypeInfo("ceylon.language::String") ceylon.language.String existing, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable?)") Callable<?> handler) {
  ...
  public FileSystem readDir(
    ...
    java.lang.String arg_0 = path.toString();
    io.vertx.core.Handler<io.vertx.core.AsyncResult<java.util.List<java.lang.String>>> arg_1 = new io.vertx.lang.ceylon.AsyncResultAdapter<java.util.List<java.lang.String>>(handler) { public Object toCeylon(java.util.List<java.lang.String> event) { return null; } };
  ...
  public List<ceylon.language.String> readDirBlocking(
    final @TypeInfo("ceylon.language::String") ceylon.language.String path) {
    java.lang.String arg_0 = path.toString();
  ...
  public FileSystem readDir(
    final @TypeInfo("ceylon.language::String") ceylon.language.String path, 
    final @TypeInfo("ceylon.language::String") ceylon.language.String filter, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|ceylon.language::List<ceylon.language::String>)") Callable<?> handler) {
    java.lang.String arg_0 = path.toString();
    java.lang.String arg_1 = filter.toString();
    io.vertx.core.Handler<io.vertx.core.AsyncResult<java.util.List<java.lang.String>>> arg_2 = new io.vertx.lang.ceylon.AsyncResultAdapter<java.util.List<java.lang.String>>(handler) { public Object toCeylon(java.util.List<java.lang.String> event) { return null; } };
  ...
  public FileSystem readFile(
    final @TypeInfo("ceylon.language::String") ceylon.language.String path, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|io.vertx.ceylon.core.buffer::Buffer)") Callable<?> handler) {
    java.lang.String arg_0 = path.toString();
  ...
  public FileSystem fsProps(
    final @TypeInfo("ceylon.language::String") ceylon.language.String path, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|io.vertx.ceylon.core.file::FileSystemProps)") Callable<?> handler) {
    java.lang.String arg_0 = path.toString();
