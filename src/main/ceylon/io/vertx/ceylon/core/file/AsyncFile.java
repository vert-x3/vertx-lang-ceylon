...
public class AsyncFile implements ReadStream<Buffer>, WriteStream<Buffer> {
  ...
  public AsyncFile write(
    ...
    final @TypeInfo("ceylon.language::Integer") long position, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable?)") Callable<?> handler) {
  ...
  public AsyncFile setReadPos(
    final @TypeInfo("ceylon.language::Integer") long readPos) {
    long arg_0 = readPos;
  ...
  public AsyncFile setWritePos(
    final @TypeInfo("ceylon.language::Integer") long writePos) {
    long arg_0 = writePos;
