...
public class Buffer {
  ...
  @TypeInfo("io.vertx.ceylon.core.buffer::Buffer")
  public static Buffer buffer(
    final @TypeInfo("ceylon.language::Integer") long initialSizeHint) {
  ...
  @TypeInfo("io.vertx.ceylon.core.buffer::Buffer")
  public static Buffer buffer(
    final @TypeInfo("ceylon.language::String") ceylon.language.String string) {
  ...
  public byte getByte(
    final @TypeInfo("ceylon.language::Integer") long pos) {
    int arg_0 = (int)pos;
  ...
  public Buffer getBuffer(
    final @TypeInfo("ceylon.language::Integer") long start, 
    final @TypeInfo("ceylon.language::Integer") long end) {
    int arg_0 = (int)start;
    int arg_1 = (int)end;
  ...
  public Buffer appendBuffer(
    final @TypeInfo("io.vertx.ceylon.core.buffer::Buffer") Buffer buff) {
  ...
  public Buffer appendUnsignedByte(
    final @TypeInfo("ceylon.language::Integer") long b) {
    short arg_0 = (short)b;
  ...
  public Buffer setBuffer(
    final @TypeInfo("ceylon.language::Integer") long pos, 
    final @TypeInfo("io.vertx.ceylon.core.buffer::Buffer") Buffer b) {
    int arg_0 = (int)pos;
