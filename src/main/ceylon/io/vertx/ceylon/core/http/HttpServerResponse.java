...
public class HttpServerResponse implements WriteStream<Buffer> {
  ...
  public HttpServerResponse setStatusCode(
    final @TypeInfo("ceylon.language::Integer") long statusCode) {
  ...
  public HttpServerResponse setStatusMessage(
    final @TypeInfo("ceylon.language::String") ceylon.language.String statusMessage) {
  ...
  public HttpServerResponse headersEndHandler(
    final @TypeInfo("ceylon.language::Anything(io.vertx.ceylon.core::Future<ceylon.language::Anything>)") Callable<?> handler) {
