...
public class HttpServerRequest implements ReadStream<Buffer> {
  ...
  public ceylon.language.String getParam(
    final @TypeInfo("ceylon.language::String") ceylon.language.String paramName) {
  ...
  public HttpServerRequest setExpectMultipart(
    final @TypeInfo("ceylon.language::Boolean") boolean expect) {
  ...
  public HttpServerRequest uploadHandler(
    final @TypeInfo("ceylon.language::Anything(io.vertx.ceylon.core.http::HttpServerFileUpload)") Callable<?> uploadHandler) {
  ...
  public ceylon.language.String getFormAttribute(
    final @TypeInfo("ceylon.language::String") ceylon.language.String attributeName) {
