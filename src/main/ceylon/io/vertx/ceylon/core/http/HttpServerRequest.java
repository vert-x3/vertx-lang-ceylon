...
public class HttpServerRequest implements ReadStream<Buffer> {
  ...
  public HttpServerRequest exceptionHandler(
    ...
    HttpServerRequest ret = io.vertx.ceylon.core.http.HttpServerRequest.TO_CEYLON.safeConvert(delegate.exceptionHandler(arg_0));
    return this;
  }
  ...
  public HttpServerRequest handler(
    ...
    HttpServerRequest ret = io.vertx.ceylon.core.http.HttpServerRequest.TO_CEYLON.safeConvert(delegate.handler(arg_0));
    return this;
  }
  ...
  public HttpServerRequest pause() {
    HttpServerRequest ret = io.vertx.ceylon.core.http.HttpServerRequest.TO_CEYLON.safeConvert(delegate.pause());
    return this;
  }
  ...
  public HttpServerRequest resume() {
    HttpServerRequest ret = io.vertx.ceylon.core.http.HttpServerRequest.TO_CEYLON.safeConvert(delegate.resume());
    return this;
  }
  ...
  public HttpServerRequest endHandler(
    ...
    HttpServerRequest ret = io.vertx.ceylon.core.http.HttpServerRequest.TO_CEYLON.safeConvert(delegate.endHandler(arg_0));
    return this;
  }
  ...
  public HttpServerRequest bodyHandler(
    ...
    HttpServerRequest ret = io.vertx.ceylon.core.http.HttpServerRequest.TO_CEYLON.safeConvert(delegate.bodyHandler(arg_0));
    return this;
  }
  ...
  public HttpServerRequest setExpectMultipart(
    ...
    HttpServerRequest ret = io.vertx.ceylon.core.http.HttpServerRequest.TO_CEYLON.safeConvert(delegate.setExpectMultipart(arg_0));
    return this;
  }
  ...
  public HttpServerRequest uploadHandler(
    ...
    io.vertx.core.Handler<io.vertx.core.http.HttpServerFileUpload> arg_0 = uploadHandler == null ? null : new io.vertx.core.Handler<io.vertx.core.http.HttpServerFileUpload>() {
      public void handle(io.vertx.core.http.HttpServerFileUpload event) {
        uploadHandler.$call$((Object)io.vertx.ceylon.core.http.HttpServerFileUpload.TO_CEYLON.safeConvert(event));
      }
    };
    HttpServerRequest ret = io.vertx.ceylon.core.http.HttpServerRequest.TO_CEYLON.safeConvert(delegate.uploadHandler(arg_0));
    return this;
  }
  ...
  public ServerWebSocket upgrade() {
    ServerWebSocket ret = io.vertx.ceylon.core.http.ServerWebSocket.TO_CEYLON.safeConvert(delegate.upgrade());
    return ret;
  }
