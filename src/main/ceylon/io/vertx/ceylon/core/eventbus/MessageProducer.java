...
public class MessageProducer implements WriteStream<Object> {
  ...
  public MessageProducer exceptionHandler(
    ...
    MessageProducer ret = io.vertx.ceylon.core.eventbus.MessageProducer.TO_CEYLON.safeConvert(delegate.exceptionHandler(arg_0));
    return this;
  }

  @DocAnnotation$annotation$(description = "todo")
  @TypeInfo("io.vertx.ceylon.core.eventbus::MessageProducer<ceylon.language::Object>")
  public MessageProducer write(
    final @TypeInfo("ceylon.language::Object?") @Name("data") @DocAnnotation$annotation$(description = "todo") Object data) {
    java.lang.Object arg_0 = io.vertx.lang.ceylon.ToJava.object(data);
    MessageProducer ret = io.vertx.ceylon.core.eventbus.MessageProducer.TO_CEYLON.safeConvert(delegate.write(arg_0));
    return this;
  }

  @DocAnnotation$annotation$(description = "todo")
  @TypeInfo("io.vertx.ceylon.core.eventbus::MessageProducer<ceylon.language::Object>")
  public MessageProducer setWriteQueueMaxSize(
    final @TypeInfo("ceylon.language::Integer") @Name("maxSize") @DocAnnotation$annotation$(description = "todo") long maxSize) {
    int arg_0 = (int)maxSize;
    MessageProducer ret = io.vertx.ceylon.core.eventbus.MessageProducer.TO_CEYLON.safeConvert(delegate.setWriteQueueMaxSize(arg_0));
    return this;
  }

  @DocAnnotation$annotation$(description = "todo")
  @TypeInfo("io.vertx.ceylon.core.eventbus::MessageProducer<ceylon.language::Object>")
  public MessageProducer drainHandler(
    ...
    MessageProducer ret = io.vertx.ceylon.core.eventbus.MessageProducer.TO_CEYLON.safeConvert(delegate.drainHandler(arg_0));
    return this;
  }

  @DocAnnotation$annotation$(description = "todo")
  @TypeInfo("io.vertx.ceylon.core.eventbus::MessageProducer<ceylon.language::Object>")
  public MessageProducer deliveryOptions(
    ...
    MessageProducer ret = io.vertx.ceylon.core.eventbus.MessageProducer.TO_CEYLON.safeConvert(delegate.deliveryOptions(arg_0));
    return this;
  }
