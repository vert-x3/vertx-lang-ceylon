...
public class SharedData {
  ...
  public <K,V> void getClusterWideMap(
    ...
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|io.vertx.ceylon.core.shareddata::AsyncMap<K,V>)") Callable<?> resultHandler) {
  ...
  public void getLock(
    final @TypeInfo("ceylon.language::String") ceylon.language.String name, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|io.vertx.ceylon.core.shareddata::Lock)") Callable<?> resultHandler) {
    java.lang.String arg_0 = name.toString();
  ...
  public void getCounter(
    final @TypeInfo("ceylon.language::String") ceylon.language.String name, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|io.vertx.ceylon.core.shareddata::Counter)") Callable<?> resultHandler) {
    java.lang.String arg_0 = name.toString();
