...
public class DnsClient {
  ...
  public DnsClient resolveMX(
    final @TypeInfo("ceylon.language::String") ceylon.language.String name, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|ceylon.language::List<io.vertx.ceylon.core.dns::MxRecord>)") Callable<?> handler) {
    java.lang.String arg_0 = name.toString();
  ...
  public DnsClient resolveSRV(
    final @TypeInfo("ceylon.language::String") ceylon.language.String name, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|ceylon.language::List<io.vertx.ceylon.core.dns::SrvRecord>)") Callable<?> handler) {
    java.lang.String arg_0 = name.toString();
  ...
  public DnsClient reverseLookup(
    final @TypeInfo("ceylon.language::String") ceylon.language.String ipaddress, 
    final @TypeInfo("ceylon.language::Anything(ceylon.language::Throwable|ceylon.language::String)") Callable<?> handler) {
