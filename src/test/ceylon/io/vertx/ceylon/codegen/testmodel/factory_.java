...
public class factory_ {
  ...
  public static ConcreteHandlerUserType createConcreteHandlerUserType(
    ...
    ConcreteHandlerUserType ret = io.vertx.ceylon.codegen.testmodel.ConcreteHandlerUserType.TO_CEYLON.converter().safeConvert(io.vertx.codegen.testmodel.Factory.createConcreteHandlerUserType(arg_0));
    return ret;
  }
  ...
  public static AbstractHandlerUserType createAbstractHandlerUserType(
    ...
    AbstractHandlerUserType ret = io.vertx.ceylon.codegen.testmodel.AbstractHandlerUserType.TO_CEYLON.converter().safeConvert(io.vertx.codegen.testmodel.Factory.createAbstractHandlerUserType(arg_0));
    return ret;
  }
  ...
  public static ConcreteHandlerUserTypeExtension createConcreteHandlerUserTypeExtension(
    ...
    ConcreteHandlerUserTypeExtension ret = io.vertx.ceylon.codegen.testmodel.ConcreteHandlerUserTypeExtension.TO_CEYLON.converter().safeConvert(io.vertx.codegen.testmodel.Factory.createConcreteHandlerUserTypeExtension(arg_0));
    return ret;
  }
