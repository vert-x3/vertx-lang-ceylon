...
public class shopifyAuth_ implements ReifiedType {

  private static final shopifyAuth_ instance = new shopifyAuth_();
  public static final TypeDescriptor $TypeDescriptor$ = TypeDescriptor.klass(shopifyAuth_.class);
  ...
  @Ignore
  @TypeInfo("io.vertx.ceylon.auth.oauth2.providers::shopifyAuth")
  public static shopifyAuth_ get_() {
    return instance;
  }
  ...
  public OAuth2Auth create(
    ...
    OAuth2Auth ret = io.vertx.ceylon.auth.oauth2.OAuth2Auth.TO_CEYLON.converter().safeConvert(io.vertx.ext.auth.oauth2.providers.ShopifyAuth.create(arg_0, arg_1, arg_2, arg_3));
    return ret;
  }
