...
public class cloudFoundryAuth_ implements ReifiedType {

  private static final cloudFoundryAuth_ instance = new cloudFoundryAuth_();
  public static final TypeDescriptor $TypeDescriptor$ = TypeDescriptor.klass(cloudFoundryAuth_.class);
  ...
  @Ignore
  @TypeInfo("io.vertx.ceylon.auth.oauth2.providers::cloudFoundryAuth")
  public static cloudFoundryAuth_ get_() {
    return instance;
  }
  ...
  public OAuth2Auth create(
    ...
    OAuth2Auth ret = io.vertx.ceylon.auth.oauth2.OAuth2Auth.TO_CEYLON.converter().safeConvert(io.vertx.ext.auth.oauth2.providers.CloudFoundryAuth.create(arg_0, arg_1, arg_2, arg_3));
    return ret;
  }
