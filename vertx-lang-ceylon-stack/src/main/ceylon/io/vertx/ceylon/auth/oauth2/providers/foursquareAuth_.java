...
public class foursquareAuth_ implements ReifiedType {

  private static final foursquareAuth_ instance = new foursquareAuth_();
  public static final TypeDescriptor $TypeDescriptor$ = TypeDescriptor.klass(foursquareAuth_.class);
  ...
  @Ignore
  @TypeInfo("io.vertx.ceylon.auth.oauth2.providers::foursquareAuth")
  public static foursquareAuth_ get_() {
    return instance;
  }
  ...
  public OAuth2Auth create(
    ...
    OAuth2Auth ret = io.vertx.ceylon.auth.oauth2.OAuth2Auth.TO_CEYLON.converter().safeConvert(io.vertx.ext.auth.oauth2.providers.FoursquareAuth.create(arg_0, arg_1, arg_2));
    return ret;
  }
  ...
  public OAuth2Auth create(
    ...
    OAuth2Auth ret = io.vertx.ceylon.auth.oauth2.OAuth2Auth.TO_CEYLON.converter().safeConvert(io.vertx.ext.auth.oauth2.providers.FoursquareAuth.create(arg_0, arg_1, arg_2, arg_3));
    return ret;
  }
