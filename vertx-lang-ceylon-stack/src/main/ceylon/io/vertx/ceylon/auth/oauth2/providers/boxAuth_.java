...
public class boxAuth_ implements ReifiedType {

  private static final boxAuth_ instance = new boxAuth_();
  public static final TypeDescriptor $TypeDescriptor$ = TypeDescriptor.klass(boxAuth_.class);
  ...
  @Ignore
  @TypeInfo("io.vertx.ceylon.auth.oauth2.providers::boxAuth")
  public static boxAuth_ get_() {
    return instance;
  }
  ...
  public OAuth2Auth create(
    ...
    final @TypeInfo("ceylon.language::String") @Name("clientId")@DocAnnotation$annotation$(description = "the client id given to you by box.com\n") ceylon.language.String clientId, 
    final @TypeInfo("ceylon.language::String") @Name("clientSecret")@DocAnnotation$annotation$(description = "the client secret given to you by box.com\n") ceylon.language.String clientSecret) {
    ...
    OAuth2Auth ret = io.vertx.ceylon.auth.oauth2.OAuth2Auth.TO_CEYLON.converter().safeConvert(io.vertx.ext.auth.oauth2.providers.BoxAuth.create(arg_0, arg_1, arg_2));
    return ret;
  }
  ...
  public OAuth2Auth create(
    ...
    OAuth2Auth ret = io.vertx.ceylon.auth.oauth2.OAuth2Auth.TO_CEYLON.converter().safeConvert(io.vertx.ext.auth.oauth2.providers.BoxAuth.create(arg_0, arg_1, arg_2, arg_3));
    return ret;
  }
