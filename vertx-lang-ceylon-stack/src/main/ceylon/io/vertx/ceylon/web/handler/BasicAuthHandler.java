...
public class BasicAuthHandler implements ReifiedType,  AuthHandler {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(BasicAuthHandler.class), io.vertx.ext.web.handler.BasicAuthHandler.class, TO_JAVA, TO_CEYLON);
