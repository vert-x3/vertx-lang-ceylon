...
public class TimeoutHandler implements ReifiedType {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(TimeoutHandler.class), io.vertx.ext.web.handler.TimeoutHandler.class, TO_JAVA, TO_CEYLON);
