...
public class ResponseTimeHandler implements ReifiedType {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(ResponseTimeHandler.class), io.vertx.ext.web.handler.ResponseTimeHandler.class, TO_JAVA, TO_CEYLON);
