...
public class SessionHandler implements ReifiedType {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(SessionHandler.class), io.vertx.ext.web.handler.SessionHandler.class, TO_JAVA, TO_CEYLON);
