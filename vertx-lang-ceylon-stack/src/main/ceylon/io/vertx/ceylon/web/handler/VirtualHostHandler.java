...
public class VirtualHostHandler implements ReifiedType {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(VirtualHostHandler.class), io.vertx.ext.web.handler.VirtualHostHandler.class, TO_JAVA, TO_CEYLON);
