...
public class UserSessionHandler implements ReifiedType {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(UserSessionHandler.class), io.vertx.ext.web.handler.UserSessionHandler.class, TO_JAVA, TO_CEYLON);
