...
public class CookieHandler implements ReifiedType {
  ...
  @Ignore public static final TypeDescriptor $TypeDescriptor$ = new io.vertx.lang.ceylon.VertxTypeDescriptor(TypeDescriptor.klass(CookieHandler.class), io.vertx.ext.web.handler.CookieHandler.class, TO_JAVA, TO_CEYLON);
