...
value oauth2 = oAuth2Auth.create(vertx, \iAUTH_CODE, JsonObject {
...
value oauth2 = oAuth2Auth.create(vertx, \iAUTH_CODE, credentials);
...
// Initialize the OAuth2 Library
value oauth2 = oAuth2Auth.create(vertx, \iPASSWORD);
...
oauth2.getToken(tokenConfig, (AccessToken|Throwable res) => {
  if (is Throwable name) {
    ...
    oauth2.api(\iGET, "/users", JsonObject {
...
// Initialize the OAuth2 Library
value oauth2 = oAuth2Auth.create(vertx, \iCLIENT, credentials);
